...
import java.io.File;
import com.example.uhfxintong.util.Configuration;
...
/**
 * 说明： com.senter.demo.uhf.modelA com.senter.demo.uhf.modelB
 * com.senter.demo.uhf.modelC 三个包分别适配了三个不同的硬件模块，各位如果要写程序，请先确认自己是哪种模块。
...
public class App extends Application {
	...
	private static final Configuration getConfiguration() {
		if (mAppConfiguration == null) {
			mAppConfiguration = new Configuration(mSinglton, "settings",
